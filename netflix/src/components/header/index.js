...
import { Profile, Picture, Dropdown, Group, Feature, FeatureCallOut, Text, Link, ButtonLink, Background, Container, Logo, Search, SearchIcon, SearchInput } from './styles/header';
